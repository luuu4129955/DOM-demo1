...
})({"8CGeJ":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
...
window.dom = {
    ...
    style (node, name, value) {
        ...
        node.style[name] = value;
            ...
            if (typeof name === "string") //dom.style(div,{color:'red'})
    ...
    class: {
        // 添加class
        add (node, className) {
            if (arguments.length === 2) node.classList.add(className);
            else if (arguments.length === 1) return node.className;
        },
        // 删除class
